...
Pod::Spec.new do |spec|
  ...
  spec.subspec "Core" do |core|
    ...
    core.resource_bundles = { "DigitalKycAssets" => ["DigitalKyc-iOS-sdk/Resources/**/*", "DigitalKyc-iOS-sdk/Models/hologram.mlmodelc"] } 
  ...
  spec.subspec "VideoKyc" do |videokyc|
    ...
    videokyc.resource_bundles = { "DigitalKycAssets" => ["DigitalKyc-iOS-sdk/Resources/**/*", "DigitalKyc-iOS-sdk/Models/hologram.mlmodelc"] }
